      ...
      <div className="container px-4 mx-auto">
        <div className="pt-10 px-6 pb-12 text-center max-w-lg mx-auto bg-white border rounded-xl shadow-3xl">
          ...
          <p className="mb-6 text-neutral-500">
            We’re working on improvements to team insights and would love your
            feedback.
          </p>
          <div className="flex flex-wrap justify-center -m-1">
            ...
            <div className="w-auto p-1">
              <a
                className="inline-flex px-5 py-2.5 text-sm text-neutral-50 font-medium bg-gradient-purple-left hover:bg-gradient-purple-left-dark rounded-lg transition duration-300"
                href="#"
              >
                Yes, Remove
              </a>
